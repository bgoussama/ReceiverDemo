...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String CUSTOM_ACTION = "com.example.receiverdemo.CUSTOM_EVENT";
    ...
    private void toggleAirplaneReceiver() {
        if (!isReceiverRegistered) {
            ...
            Toast.makeText(this, "Receiver dynamique activé", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Receiver dynamique désactivé", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void sendCustomBroadcast() {
        ...
        /*
         * Broadcast custom interne :
         * on cible explicitement CustomEventReceiver pour éviter les problèmes
         * des broadcasts implicites sur les versions récentes d'Android.
         */
        intent.setClass(this, CustomEventReceiver.class);

        intent.putExtra("message", "Bonjour depuis MainActivity !");
